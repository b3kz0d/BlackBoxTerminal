...
namespace BlackBoxTerminal.Controls
{
    ...
    public class SpectrumSlider : Slider
    {
        ...
        public static readonly DependencyProperty SelectedColorProperty =
            ...
            new PropertyMetadata(System.Windows.Media.Colors.Transparent,OnCustomConnectorsChanged));
        ...
        private static void OnCustomConnectorsChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (spectrumSlider!=null&&e.NewValue != null&&e.NewValue!=e.OldValue)
            {
                var color = (Color) e.NewValue;
                var hsv=ColorUtilities.ConvertRgbToHsv(color.R, color.G, color.B);
                spectrumSlider.Value = hsv.H;
        ...
        private void createSpectrum()
        {
            ...
            pickerBrush.StartPoint = new Point(1, 0.5);
            pickerBrush.EndPoint = new Point(0, 0.5);
    ...
    public class ValidatedTextBox : TextBox
    {
        ...
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ValidatedTextBox),
                new FrameworkPropertyMetadata(typeof(ValidatedTextBox))); 
        }

        public static readonly DependencyProperty DataTypeProperty =
            DependencyProperty.Register("DataType", typeof(DataType), typeof(ValidatedTextBox));
        public DataType DataType
        {
            get
            {
                return (DataType)base.GetValue(DataTypeProperty);
            }
            set
            {
